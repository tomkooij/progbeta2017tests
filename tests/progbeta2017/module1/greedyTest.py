...
def handlesWrongInput(test):
	test.test = lambda : assertlib.numberOnLine(0, lib.getLine(lib.outputOf(_fileName, [-9.50, -327, -1, 0]), 0))
	test.description = lambda : "handelt een verkeerde input van -9.50, -327 en -1 af"